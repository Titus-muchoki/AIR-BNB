...
public class Sql2oBookingDao implements BookingDao {
    ...
    public void add(Booking booking) {
        String sql = "INSERT INTO bookings (description, startDate, endDate, clientName,  email,  categoryId) VALUES (:description, :startDate, :endDate, :clientName, :email, :categoryId)"; //raw sql
    ...
    @Override
    public void update(int id, String newDescription, String newStartDate, String newEndDate, String newClientName,  String email, int newCategoryId) {
        String sql = "UPDATE bookings SET (description, startDate, endDate, clientName,  email, categoryId) = (:description, :startDate, :endDate, :clientName, :email, :categoryId) WHERE id=:id";
        try(Connection con = sql2o.open()){
            con.createQuery(sql)
                    .addParameter("description", newDescription)
                    .addParameter("startDate", newStartDate)
                    .addParameter("endDate", newEndDate)
